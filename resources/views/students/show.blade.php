<x-default-layout title="Student" section_title="Student detail">
    <div class="grid grid-cols-3">
        <div
            ...
            <div class="flex flex-col gap-2">
                <div>Gender</div>
                <div class="px-3 py-2 border border-zinc-300 ">{{ ucfirst($student->gender) }}</div>
            </div>
            <div class="flex flex-col gap-2">
                <div>Majors</div>
                <div class="px-3 py-2 border border-zinc-300 ">
                    {{ $student->major == 1 ? 'S1 Teknik Informatika' : 'S1 Sistem Informasi' }}
                </div>
            </div>
            <div class="flex flex-col gap-2">
                <div>Status</div>
                <div class="px-3 py-2 border border-zinc-300 ">{{ ucfirst($student->status) }}</div>
            </div>
