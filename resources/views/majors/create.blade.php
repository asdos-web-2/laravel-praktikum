<x-default-layout title="Majors" section_title="Add new majors">
            ...
            <div class="grid sm:grid-cols-2 gap-4">
                ...
                <div class="flex flex-col gap-2">
                    ...
                    <input type="text" id="code" name="code" class="px-3 py-2 border border-zinc-300 bg-slate-50"
                        placeholder="Majors Code (e.g., F55122001)">
                </div>
            </div>
            <div class="flex flex-col gap-2">
                <label for="description">Description</label>
                <textarea id="description" name="description" placeholder="Enter description" 
                    class="px-3 py-2 border border-zinc-300 bg-slate-50"></textarea>
            </div>
